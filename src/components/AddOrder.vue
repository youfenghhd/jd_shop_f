        ...
        <el-container class="container">
            ...
            <el-main class="body_content">
                <div class="single_part address">
                    <el-row>
                        <el-col :span="2" style="text-align: center"><i class="el-icon-location-outline position" />
                        </el-col>
                        <el-col :span="20">
                            <div class="input-address" @click="dialogVisible = true" v-if="nowUserInfo.user_order_addr">
                        ...
                        <el-col :span="2" style="text-align: center"><i class="el-icon-arrow-right arrow-right" />
                        </el-col>
                    </el-row>
                    <div></div>
                </div>
                <div class="single_part send_time">
                    <el-row>
                        <el-col :span="8">
                            <div class="left"><span>送达时间</span></div>
                        </el-col>
                        <el-col :span="16">
                            <div class="right">尽快送达 | 预计 28 小时</div>
                        </el-col>
                    </el-row>
                </div>
                <div class="single_part goods_detail">
                    <div class="single-goods" v-for="(good, index) in goods" :key="index">
                        <el-col :span="6" style="text-align: center">
                            <el-image class="images" fit="contain" :src="getImgUrl(good.image)">
                        ...
                        <el-col :span="4" class="price-part"><span>￥</span><span class="price">{{
                            good.cprice * good.canumber
                        }}</span>
                            <span class="counts">共{{ good.canumber }}件</span>
                        </el-col>
                    </div>
                </div>
            </el-main>
            <el-footer class="footer">
                ...
                <el-col :span="4">
                    <div class="right" @click="doAddOrder()">确认下单</div>
                </el-col>
            </el-footer>
        </el-container>
        ...
        <el-dialog title="请填写" :visible.sync="dialogVisible" width="30%">
            <el-form :model="form">
                <el-form-item label="收货地址">
                    <el-input v-model="form.orderAddr" autocomplete="off" placeholder="请填写您的收货地址"></el-input>
                </el-form-item>
            </el-form>
    ...
    methods: {
        ...
        async queryCartInfo() {
            if (this.goods.length) {
                this.goods.forEach((good) => (this.totalPrice += good.cprice * good.canumber));
                //this.queryUserInfo();
            }
        },
        //3.获取用户信息
        ...
        addOrder() {
            this.$axios({
                url: 'http://localhost:8066/indent/insert',
                method: 'post',
                data: {
                    uid: this.$store.state.User.uid,
                    oprice: this.$store.state.Balance,
                    orderinfo: "操作员:HUANGHUIDA",
                    oaddress: this.$data.address
                }
            }).then(response => {
        ...
        getImgUrl(src) {
            return "http://localhost:8066/images/" + src
        },
    },
};
</script>
